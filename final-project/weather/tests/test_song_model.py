...
def mock_cursor(mocker):
    ...
    mocker.patch("weather.models.song_model.get_db_connection", mock_get_db_connection)
...
def test_get_random_song(mock_cursor, mocker):
    ...
    mock_random = mocker.patch("weather.models.song_model.get_random", return_value=2)
...
def test_get_random_song_empty_catalog(mock_cursor, mocker):
    ...
    mock_random = mocker.patch("weather.models.song_model.get_random")
